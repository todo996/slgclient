import { _decorator, Component, Label, ScrollView, Button, Color, EditBox, Graphics, HorizontalTextAlignment, Node, Sprite, UITransform, VerticalTextAlignment } from 'cc';
