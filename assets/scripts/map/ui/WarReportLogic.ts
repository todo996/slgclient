import { _decorator, Component, Label, Node, Prefab, ScrollView, instantiate, Button, Color, EditBox, Graphics, HorizontalTextAlignment, Sprite, UITransform, VerticalTextAlignment } from 'cc';
