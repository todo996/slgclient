import { _decorator, Component, Layout, Prefab, Vec3, instantiate, Button, Color, EditBox, Graphics, HorizontalTextAlignment, Label, Node, Sprite, UITransform, VerticalTextAlignment } from 'cc';
