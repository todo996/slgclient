import { _decorator, Component, Label, ScrollView, UITransform, Button, Color, EditBox, Graphics, HorizontalTextAlignment, Node, Sprite, VerticalTextAlignment } from 'cc';
