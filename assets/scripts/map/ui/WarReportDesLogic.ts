...
export default class WarReportDesLogic extends Component {
    ...
    private applyModernDetail(): void {
        ...
        ui().drawAncientPanel(this.node, 500, 520, 10);

        const title = ui().createUiText(
            this.node,
            '__WarDetailTitle',
            'CHI TIẾT CHIẾN ĐẤU',
            20,
